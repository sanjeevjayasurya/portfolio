export const Hero = () => {
  return (
    <section className="min-h-screen w-full bg-white dark:bg-gray-800 px-6 md:px-24 xl:px-36">
      <div className="flex justify-center max-w-screen-2xl flex-start h-screen flex-col lg:mx-20">
